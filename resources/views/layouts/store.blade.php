...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('template/plugins/ps-icon/style.css') }}">
  <!-- CSS Library-->
  <link rel="stylesheet" href="{{ asset('template/plugins/bootstrap/dist/css/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('template/plugins/owl-carousel/assets/owl.carousel.css') }}">
  <link rel="stylesheet" href="{{ asset('template/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css') }}">
  <link rel="stylesheet" href="{{ asset('template/plugins/slick/slick/slick.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('template/plugins/jquery-ui/jquery-ui.min.css') }}">
  <link rel="stylesheet" href="{{ asset('template/plugins/revolution/css/settings.css') }}">
  <link rel="stylesheet" href="{{ asset('template/plugins/revolution/css/layers.css') }}">
...
<body class="ps-loading">
            ...
            <div class="header__actions">
                @guest
                    ...
                    @else
                              ...
                              <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.querySelector('#form1').submit();"> Logout<form action="{{ route('logout') }}" method="post" id="form1">@csrf</form></a>
              ...
              <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i class="fa fa-angle-down"></i></a>
                <ul class="dropdown-menu">
                  <li><a href="#"><img src="{{ asset('template/images/flag/usa.svg') }}" alt=""> USD</a></li>
                  <li><a href="#"><img src="{{ asset('template/images/flag/singapore.svg') }}" alt=""> SGD</a></li>
                  <li><a href="#"><img src="{{ asset('template/images/flag/japan.svg') }}" alt=""> JPN</a></li>
                </ul>
              </div>
  ...
  <div class="header-services">
    <div class="ps-services owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="false" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1"
  ...
  <script type="text/javascript" src="{{ asset('template/plugins/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/owl-carousel/owl.carousel.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/gmap3.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/imagesloaded.pkgd.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/isotope.pkgd.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/jquery.matchHeight-min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/slick/slick/slick.min.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ asset('template/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/revolution/js/extensions/revolution.extension.navigation.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('template/plugins/revolution/js/extensions/revolution.extension.parallax.min.js') }}"></script>
